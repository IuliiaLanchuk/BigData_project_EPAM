...
from weather_analysis.application.enriching_data.multithreading_address_enrichment import \
    multithreading_data_enrichment_with_address
...
def main(input_folder: str, output_folder: str, n_threads: int) -> None:
    ...
    print('Analysis is over. See results in output folder')
